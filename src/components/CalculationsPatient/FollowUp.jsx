...
const FollowUp = ({ onReturn }) => {
  ...
  return (
    <div className="pt-3 px-3 px-md-5">
          ...
          {showOD && showOS && (
            <div className="row">
              <div
                ...
                style={{ backgroundColor: "#4888C8" }}
              >
                <p className="fs-6 text-center">OD</p>
              </div>
              <div
                className="col-12 col-md-6"
                style={{ backgroundColor: "#2FB297" }}
              >
      ...
      {patient ? (
        <div className="d-flex flex-column flex-md-row justify-content-evenly text-align-center">
          <div>
            <h4 className="mb-1 fs-4 fw-bold">
              Patient:{" "}
              <small class="text-muted">{`${patient.name} ${patient.surname}`}</small>
            </h4>
            <h4 className="mb-1 fs-4 fw-bold">
          ...
          <div>
            <h4 className="mb-1 fs-4 fw-bold">
              MRN:{" "}
              <small class="text-muted">{`${patient.medical_record}`}</small>
            </h4>
