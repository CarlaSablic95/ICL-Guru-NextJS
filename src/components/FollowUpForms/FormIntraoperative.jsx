      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="container">
          <div className="row justify-content-center justify-content-md-start">
            ...
            <div className="col-10 col-md-4 mb-4">
              <div className="d-flex flex-column align-items-start">
                ...
                <div className="input-group mb-3">
                  <input type="number" step="0.001" className="form-control vault" id="c_vault_postop_QX" aria-describedby="Central vault" name="c_vault_postop_QX" {...register("c_vault_postop_QX")} />
            ...
            <div className="col-10 col-md-4 mb-4">
              <div className="d-flex flex-column align-items-start">
                ...
                <div className="input-group">
                  <select
                    className={`form-select ${errors.size_postop ? "border border-2 border-danger" : ""}`} id="id_size_postop" name="size_postop" aria-label="IOL overall diameter"
            ...
            <div className="col-10 col-md-4 mb-4">
              <div className="d-flex flex-column align-items-start">
                ...
                <div className="input-group">
                  <select
                    className={`form-select ${errors.end_position ? "border border-2 border-danger" : ""}`} id="id_end_position" name="end_position" aria-label="IOL final position" {...register("end_position",{ required: true })}
                  >
                    <option value="">Select an option</option>
          ...
          <div className="row justify-content-center justify-content-md-start">
            ...
            <div className="col-10 col-md-4 mb-4">
              <div className="d-flex flex-column align-items-start mb-4">
                ...
                <div className="input-group mb-3">
                  <input type="number" step="0.001" className="form-control vault" id="c_vault_init_postop_QX" aria-describedby="Central vault" name="c_vault_init_postop_QX" {...register("c_vault_init_postop_QX")} />
                  <span className="input-group-text" style={{ backgroundColor:"#e9ecef" }} id="basic-addon2">mm</span>
                </div>
              </div>
            </div>
          ...
          <div className="d-flex justify-content-center">
            <Button type="submit" title="Save" bgColor="#B02F92" textColor="#fefefe" rounded="2rem" textTransform="uppercase" />
          </div>
        </div>
        </form>
      </div>
