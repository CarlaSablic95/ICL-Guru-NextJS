              ...
              <div className="row justify-content-center justify-content-md-start">
                ...
                <div className="col-10 col-md-4 mb-3">
                  <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="input-group">
                      <input type="number" step="0.001" className="form-control vault" id="id_c_vault_IMM" aria-describedby="Central vault" name="c_vault" {...register("c_vault")}/>
                 ...
                 <div className="col-10 col-md-4 mb-3">
                  <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="input-group">
                      <input type="number" step="0.001" className="form-control vault" id="id_n_p_vault_IMM" aria-describedby="Nasal peripheral vault" name="n_p_vault" {...register("n_p_vault")} />
                      <span className="input-group-text" id="basic-addon2" style={{ backgroundColor:"#E9ECEF" }}>mm</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-10 col-md-4 mb-3">
                  <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="input-group">
                      <input type="number" step="0.001" className="form-control vault" id="id_t_p_vault_IMM" aria-describedby="Temporal peripheral vault" name="t_p_vault" {...register("t_p_vault")}/>
                      <span className="input-group-text" id="basic-addon2" style={{ backgroundColor:"#E9ECEF" }}>mm</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-10 col-md-4 mb-4">
                  <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="input-group">
                      <input type="number" step="0.1" className="form-control angle" id="id_n_angle_IMM" aria-describedby="Nasal angle" name="n_angle" {...register("n_angle")}/>
                ...
                <div className="col-10 col-md-4 mb-4">
                  <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="input-group">
                      <input type="number" step="0.1" className="form-control angle" id="id_t_angle_IMM" aria-describedby="Temporal angle" name="t_angle" {...register("t_angle")}/>
                      <span className="input-group-text" id="basic-addon2" style={{ backgroundColor:"#E9ECEF" }}>°</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-10 col-md-4 mb-4">
                  <div className="d-flex flex-column align-items-start">
                    ...
                    <div className="input-group">
                      <input type="number" step="0.001" className="form-control pupil" id="id_pupil_IMM" aria-describedby="Pupil diameter" name="pupil" {...register("pupil")}/>
                      <span className="input-group-text" id="basic-addon2" style={{ backgroundColor:"#E9ECEF" }}>mm</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="row justify-content-center justify-content-md-start">
              ...
              <div className="col-10 col-md-4 mb-4">
                <div className="d-flex flex-column align-items-start">
                  ...
                  <div className="input-group">
                      <input type="number" step="0.1" className="form-control" id="id_rx_sph_IMM" aria-describedby="RX Sphere" name="rx_sph" {...register("rx_sph")} />
              ...
              <div className="col-10 col-md-4 mb-3">
                <div className="d-flex flex-column align-items-start">
                  ...
                  <div className="input-group">
                      <input type="number" step="0.1" className="form-control" id="id_rx_cyl_IMM" aria-describedby="RX Cylinder" name="rx_cyl" {...register("rx_cyl")}/>
                      <span className="input-group-text" id="basic-addon2" style={{ backgroundColor:"#E9ECEF" }}>D</span>
                  </div>
                </div>
              </div>
               ...
               <div className="col-10 col-md-4 mb-3">
                <div className="d-flex flex-column align-items-start mb-4">
                  ...
                  <div className="input-group">
                      <input type="number" step="0.001" className="form-control" id="id_rx_axis_IMM" aria-describedby="RX Axis" name="rx_axis" {...register("rx_axis")}/>
                      <span className="input-group-text" id="basic-addon2" style={{ backgroundColor:"#E9ECEF" }}>°</span>
                  </div>
                </div>
              </div>
