...
const FilesOS = () => {
    return (
        <div className="modal fade" id="filesOS" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                <div className="modal-dialog modal-dialog-centered py-5">
                    <div className="modal-content">
                    <div className="d-flex justify-content-between p-2"> 
                        <h4 className="ps-3">OS - Please, choose a file</h4>
