        ...
        <div className="modal fade" id={id} tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                <div className="modal-dialog modal-dialog-centered py-5">
                    ...
                    <div className="modal-body pb-0">
                        ...
                        <p style={{ fontSize:"17px" }} className="mb-4">{description}</p>
                    </div>

                    <div className="modal-footer border border-0 justify-content-center">
                        <button type="button" className="btn" data-bs-dismiss="modal" style={{ backgroundColor:"#00507c" }}>Understood</button>
                    </div>
                    </div>
                </div>
            </div>
