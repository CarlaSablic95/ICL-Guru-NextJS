...
const CreatePatient = () => {
    return (
        <div className="modal fade" id="createPatient" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div className="modal-body pb-0">
                    <BaseForm>
                        ...
                        <div className="modal-footer border-0 d-flex justify-content-center">
                            <Button2 type="submit" title="Submit" bgColor="#3DC2DD" textColor="#ffffff" />
                        </div>
                    </BaseForm>
                </div>
                </div>
