                      ...
                      <div className={`${errors.nk_121_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_121_od"
                            name="nk_121_od"
                            {...register("nk_121_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                      ...
                      <div className={`${errors.nk_126_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_126_od"
                            name="nk_126_od"
                            {...register("nk_126_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.nk_126_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            {...register("nk_132_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.nk_137_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_137_od"
                            name="nk_137_od"
                            {...register("nk_137_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_121_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_121_od"
                            name="ks_121_od"
                            {...register("ks_121_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_126_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_126_od"
                            name="ks_126_od"
                            {...register("ks_126_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_132_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_132_od"
                            name="ks_132_od"
                            {...register("ks_132_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_137_od ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_137_od"
                            name="ks_137_od"
                            {...register("ks_137_od", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.nk_121_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_121_os"
                            name="nk_121_os"
                            {...register("nk_121_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.nk_126_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_126_os"
                            name="nk_126_os"
                            {...register("nk_126_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.nk_132_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_132_os"
                            name="nk_132_os"
                            {...register("nk_132_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.nk_137_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_nk_137_os"
                            name="nk_137_os"
                            {...register("nk_137_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_126_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_126_os"
                            name="ks_126_os"
                            {...register("ks_126_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_132_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_132_os"
                            name="ks_132_os"
                            {...register("ks_132_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
                      ...
                      <div className={`${errors.ks_137_os ? "mb-0" : "mb-3"}`}>
                        ...
                        <div className="input-group">
                          <input
                            ...
                            id="id_ks_137_os"
                            name="ks_137_os"
                            {...register("ks_137_os", { required: true })}
                            disabled={isEnabled}
                          />
                          <span
                            className="input-group-text"
