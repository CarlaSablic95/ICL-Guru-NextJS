              ...
              >
                ...
                >
                  ...
                  <div className={`${errors.ata_od ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_ata_od" className="form-label fw-bold">
                      ATA:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        ...
                        className={`form-control ${
                          errors.ata_od ? "border border-2 border-danger" : ""
                        }`}
                        {...register("ata_od", { required: true })}
                        name="ata_od"
                        disabled={isEnabled}
                      />
                      <span
                  ...
                  <div className={`${errors.arise_od ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_arise_od" className="fw-bold">
                      aRISE:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        type="number"
                        step="0.001"
                        className={`form-control ${
                          errors.arise_od ? "border border-2 border-danger" : ""
                        }`}
                        id="id_arise_od"
                        aria-label="aRISE"
                        aria-describedby="aRISE"
                        name="arise_od"
                        {...register("arise_od", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                        className="input-group-text"
                  ...
                  <div className={`${errors.acd_od ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_acd_od" className="fw-bold">
                      ACD:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        type="number"
                        step="0.001"
                        className={`form-control ${
                          errors.acd_od ? "border border-2 border-danger" : ""
                        }`}
                        id="id_acd_od"
                        aria-label="ACD"
                        aria-describedby="ACD"
                        name="acd_od"
                        {...register("acd_od", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                        className="input-group-text"
                ...
                >
                  ...
                  <div className={`${errors.ata_os ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_ata_os" className="fw-bold">
                      ATA:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        ...
                        step="0.001"
                        className={`form-control ${
                          errors.ata_os ? "border border-2 border-danger" : ""
                        }`}
                        id="id_ata_os"
                        aria-label="AtA"
                        aria-describedby="AtA"
                        name="ata_os"
                        {...register("ata_os", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                        className="input-group-text"
                  ...
                  <div className={`${errors.arise_os ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_arise_os" className="fw-bold">
                      aRISE:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        ...
                        step="0.001"
                        className={`form-control ${
                          errors.arise_os ? "border border-2 border-danger" : ""
                        }`}
                        id="id_arise_os"
                        aria-label="aRISE"
                        aria-describedby="aRISE"
                        name="arise_os"
                        {...register("arise_os", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                        className="input-group-text"
                  ...
                  <div className={`${errors.acd_os ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_acd_os" className="fw-bold">
                      ACD:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        ...
                        step="0.001"
                        className={`form-control ${
                          errors.acd_os ? "border border-2 border-danger" : ""
                        }`}
                        id="id_acd_os"
                        aria-label="ACD"
                        aria-describedby="ACD"
                        name="acd_os"
                        {...register("acd_os", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                        className="input-group-text"
