      ...
      <div className="card rounded-5" style={{ width: "100%" }}>
        <div className="card-body">
          ...
          <p className="fw-bold text-center mb-3">
            (Required for reference and validation only)
          </p>
              ...
              >
                ...
                >
                  ...
                  <div className={`${errors.wtw_od ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_wtw_od" className="fw-bold">
                      WTW:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        ...
                        className={`form-control ${
                          errors.wtw_od ? "border border-2 border-danger" : ""
                        }`}
                        id="id_wtw_od"
                        aria-label="WTW"
                        aria-describedby="WTW"
                        name="wtw_od"
                        {...register("wtw_od", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                ...
                >
                  ...
                  <div className={`${errors.wtw_os ? "mb-0" : "mb-3"}`}>
                    <label htmlFor="id_wtw_os" className="fw-bold">
                      WTW:<span className="text-danger">*</span>
                    </label>
                    <div className="input-group">
                      <input
                        ...
                        step="0.001"
                        className={`form-control ${
                          errors.wtw_os ? "border border-2 border-danger" : ""
                        }`}
                        id="id_wtw_os"
                        aria-label="WTW"
                        aria-describedby="WTW"
                        name="wtw_os"
                        {...register("wtw_os", { required: true })}
                        disabled={isEnabled}
                      />
                      <span
                        className="input-group-text"
