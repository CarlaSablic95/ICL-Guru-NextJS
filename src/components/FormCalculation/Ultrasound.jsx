                ...
                >
                  ...
                  <div className="d-flex justify-content-evenly mb-4">
                    <button
                      ...
                      onClick={() => handleOptionClick("OD", "Cloud")}
                    >
                      Cloud
                    </button>
                    <button
                      type="button"
                      className={`btn py-2 px-4 ${
                        selectedOptionOD === "Local"
                          ? "selected-button"
                          : "unselected-button"
                      }`}
                      onClick={() => handleOptionClick("OD", "Local")}
                    >
                      Local
                    </button>
                  </div>
                  ...
                  {selectedOptionOD === "Cloud" ? (
                    <div className="d-flex justify-content-center mb-4">
                      <button
                        type="button"
                        className="btn py-2 px-4 text-white rounded-5 btn-cloud"
                        id="id_iclguru_cloud_od"
                        style={{ color: "#0051A1", backgroundColor: "#3DC2DD" }}
                        data-bs-toggle="modal"
                        data-bs-target="#filesOD"
                      >
                        Upload from ICLGuru Cloud
                      </button>
                    </div>
                  ) : (
                    <div className="mb-3">
                      <label htmlFor="id_eyeOD_us" className="form-label w-100">
                        <div className="form-control d-flex justify-content-between align-items-center rounded-4">
                          ...
                          <button
                            type="button"
                            className="btn py-2 px-4 btn-cloud"
                            id="btn-cloud"
                            style={{
                      ...
                      <input
                        className="form-control d-none btn-local"
                        type="file"
                        id="id_eyeOD_us"
                        name="eyeOD_us"
                  ...
                  <form action="">
                    ...
                    >
                      ...
                      <option value="sonomed_u">
                        Sonomed Escalon VuMAX HD / VuPad
                      </option>
                  ...
                  <div>
                    <div className="d-flex justify-content-evenly mb-4">
                      <button
                        type="button"
                        className={`btn py-2 px-4 ${
                          selectedOptionOS === "Cloud"
                            ? "selected-button"
                            : "unselected-button"
                        }`}
                        onClick={() => handleOptionClick("OS", "Cloud")}
                      >
                        Cloud
                      </button>
                      ...
                      <button
                        type="button"
                        className={`btn py-2 px-4 ${
                          selectedOptionOS === "Local"
                            ? "selected-button"
                            : "unselected-button"
                        }`}
                        onClick={() => handleOptionClick("OS", "Local")}
                      >
                        Local
                      </button>
                    </div>
                    ...
                    {selectedOptionOS === "Cloud" ? (
                      <div className="d-flex justify-content-center mb-4">
                        <button
                          type="button"
                          className="btn py-2 px-4 text-white rounded-5 btn-cloud"
                          id="id_iclguru_cloud_os"
                          style={{
                            color: "#0051A1",
                            backgroundColor: "#3DC2DD",
                          }}
                          data-bs-toggle="modal"
                          data-bs-target="#filesOS"
                        >
                          Upload from ICLGuru Cloud
                        </button>
                      </div>
                      ...
                      <div className="mb-3">
                        <label for="id_eyeOS_us" className="form-label w-100">
                          <div className="form-control d-flex justify-content-between align-items-center rounded-4">
                            ...
                            <button
                              type="button"
                              className="btn py-2 px-4 btn-local"
                              style={{
                                backgroundColor: "rgb(24, 73, 214)",
                                textTransform: "capitalize",
                                borderRadius: "0.5rem",
