...
const accountsForClinic = accounts.filter((account) => account.organizations && account.organizations.some((org) => org.id === Number(clinicId)));
        ...
        <div className="pb-5">
          <div className="table-responsive mb-4">
            <table className={`table table-striped ${styles.tableAccounts}`}>
              ...
              <tbody>
                { accountsForClinic.length > 0 ? (accountsForClinic.map((account) => (
                  ...
                  <td className="text-center align-middle">{account.email}</td>
                  </tr>
                ))) :
                (
                  <tr>
                    <td colSpan="3" className="text-center">No hay cuentas asociadas</td>
                  </tr>
                )
