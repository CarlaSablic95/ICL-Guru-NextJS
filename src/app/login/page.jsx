...
const Login = () => {
  ...
  return (
    <section
      className={`${styles.background} d-flex align-items-center col-12 mx-auto`}
    >
      <div className="container">
        <div className="row justify-content-center form-login">
          <div
            className={`col-10 col-lg-5 ${styles.backgroundContainer} d-none d-lg-block`}
          ></div>
          <div
            className={`col-10 col-lg-5 px-2 px-md-4 ${styles.backgroundForm} d-flex flex-column justify-content-center`}
          >
              ...
              >
                ...
                {loginError && (
                  <div className="text-center mb-3">
                    <small className="text-danger fw-bold">{loginError}</small>
                  </div>
                )}
